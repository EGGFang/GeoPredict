...
def read_data():
    ...
    if TYPE == "B":
        ...
        partitionings.append(16)
        partitionings.append(365)
    elif TYPE == "C":
        partitionings.append(3)
...
def train(epochs, batch_size, lr, check_point=False):
    ...
    while epoch < epochs:
        ...
        if epoch % 1 == 0:
            ...
            # torch.save(classifier, f"./output/classifier_{epoch}.pt")
...
def preprocess(data):
    ...
    data = transform(data.to(torch.float16))
